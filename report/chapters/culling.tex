...
To illustrate this, \autoref{fig:culling1} shows the maps of two robots in a toy example.
...
\autoref{fig:culling2} shows the \acp{KF} which are directly connected to the \acp{KF} of a \ac{KFM} indicated by dashed rectangles.
...
The toy example with culled \acp{KF} is shown in \autoref{fig:culling3}.
