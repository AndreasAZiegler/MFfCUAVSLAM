...
If the same settings are now used with a data set, that contains only a small overlapping area, the map merging approach will probably fail as it won't be able to find the required number of \acp{KFM}.
