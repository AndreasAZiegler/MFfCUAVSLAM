...
{
//    cout << "ORBmatcher::SearchByProjection(Frame &F, const vector<mpptr> &vpMapPoints, const float th)" << endl;
//    cout << "********RIGHT************" << endl;
...
//    cout << "pKF->MapPointMatches: " << vpMapPointsKF.size();
//    cout << "HistoLength: " << HISTO_LENGTH << endl;
...
//    cout << "SearchByBoW: pKF->mFeatVec Size:" << pKF->mFeatVec.size() << endl;
...
//    cout << "SearchByBoW: matches before orientation check:" << nmatches << endl;
...
//    cout << "SearchByBoW: matches after orientation check:" << nmatches << endl;
...
int ORBmatcher::SearchByBoW(kfptr pKF1, kfptr pKF2, vector<mpptr> &vpMatches12)
{
...
{
//    cout << "ORBmatcher::SearchByProjection(Frame &CurrentFrame, const Frame &LastFrame, const float th)" << endl;
//    cout << "********WRONG************" << endl;

    //Performance: delete stereo case
