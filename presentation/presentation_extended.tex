...
\frame{
  ...
  \end{figure}
  Reduction of the error from $\text{rmse} = 0.1311$ to $\text{rmse} = 0.0961$
}
...
\section{Different opt.}
\frame{\tableofcontents[currentsection]}

\frame{
  \frametitle{Different optimizer - Use dog leg optimizer}
...
\frame{
  \frametitle{Different optimizer - \gls{lm}}
  \visible<1->{
...
\frame{
  \frametitle{Different optimizer - \gls{dl}}
  \visible<1->{
