...
ax2.set_ylabel('Y')
ax2.set_zlabel('Z')
ax2.scatter(list_leica_x_1, list_leica_y_1, list_leica_z_1, c='green')
ax2.scatter(leica_1[:,1], leica_1[:,2], leica_1[:,3], c='red', s=100)
...
ax2.set_ylabel('Y')
ax2.set_zlabel('Z')
ax2.scatter(list_leica_x_2, list_leica_y_2, list_leica_z_2, c='green')
ax2.scatter(leica_2[:,1], leica_2[:,2], leica_2[:,3], c='red', s=100)

fig = plt.figure()
fig.suptitle('Leica and SLAM transformed Map 1')
ax3 = fig.add_subplot(111, projection='3d')
ax3.scatter(slam_1_transformed[:,0], slam_1_transformed[:,1], slam_1_transformed[:,2], c='blue')
ax3.scatter(leica_1[:,1], leica_1[:,2], leica_1[:,3], c='red')
